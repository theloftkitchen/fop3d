...
typedef int (*LMC1_GETPENPARAM)(int      nPenNo,//要设置的笔号(0-255)					 
					 ...
					 double&   m_dCurrent,//电流A
					 int&      m_nFreq,//频率HZ
					 int&      m_nQPulseWidth,//Q脉冲宽度us	
					 int&      m_nStartTC,//开始延时us
					 int&      m_nEndTC,//结束延时us
					 int&      m_nPolyTC,//拐角延时us   //	
					 double&   m_dJumpSpeed, //跳转速度mm/s
					 int&      m_nJumpPosTC, //跳转位置延时us
					 int&      m_nJumpDistTC,//跳转距离延时us	
					 double&   m_dEndComp,//末点补偿mm
					 double&   m_dAccDist,//加速距离mm	
					 double&   m_dPointTime,//打点延时 ms						 
					 BOOL&     m_bPulsePointMode,//脉冲点模式 
					 int&      m_nPulseNum,//脉冲点数目
					 double&   dFlySpeed);
//设置指定笔号对应的加工参数
